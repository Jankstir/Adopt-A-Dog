		...
		<div class="main-content-wrapper">
			<div class="main-content single" style="margin-left: 25px">
				...
				<tbody>
					...
					//DAY 1
					$querystring = "SELECT day FROM appointment WHERE day=1 AND dog='Bruce'";
					...
					//DAY 2
					$querystring = "SELECT day FROM appointment WHERE day=2 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 3
					$querystring = "SELECT day FROM appointment WHERE day=3 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 4
					$querystring = "SELECT day FROM appointment WHERE day=4 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 5
					$querystring = "SELECT day FROM appointment WHERE day=5 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 6
					$querystring = "SELECT day FROM appointment WHERE day=6 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 7
					$querystring = "SELECT day FROM appointment WHERE day=7 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 8
					$querystring = "SELECT day FROM appointment WHERE day=8 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 9
					$querystring = "SELECT day FROM appointment WHERE day=9 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 10
					$querystring = "SELECT day FROM appointment WHERE day=10 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 11
					$querystring = "SELECT day FROM appointment WHERE day=11 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 12
					$querystring = "SELECT day FROM appointment WHERE day=12 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 13
					$querystring = "SELECT day FROM appointment WHERE day=13 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 14
					$querystring = "SELECT day FROM appointment WHERE day=14 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 15
					$querystring = "SELECT day FROM appointment WHERE day=15 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 16
					$querystring = "SELECT day FROM appointment WHERE day=16 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 17
					$querystring = "SELECT day FROM appointment WHERE day=17 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 18
					$querystring = "SELECT day FROM appointment WHERE day=18 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 19
					$querystring = "SELECT day FROM appointment WHERE day=19 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 20
					$querystring = "SELECT day FROM appointment WHERE day=20 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 21
					$querystring = "SELECT day FROM appointment WHERE day=21 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 22
					$querystring = "SELECT day FROM appointment WHERE day=22 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 23
					$querystring = "SELECT day FROM appointment WHERE day=23 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 24
					$querystring = "SELECT day FROM appointment WHERE day=24 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 25
					$querystring = "SELECT day FROM appointment WHERE day=25 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 26
					$querystring = "SELECT day FROM appointment WHERE day=26 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 27
					$querystring = "SELECT day FROM appointment WHERE day=27 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 28
					$querystring = "SELECT day FROM appointment WHERE day=28 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 29
					$querystring = "SELECT day FROM appointment WHERE day=29 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 30
					$querystring = "SELECT day FROM appointment WHERE day=30 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
					...
					//DAY 31
					$querystring = "SELECT day FROM appointment WHERE day=31 AND dog='Bruce'";
					$result = $db->query($querystring);
					if($row = mysqli_fetch_array($result)) {
						echo "<td><div class=\"unavailable\">not available.</div></td>";
					} elseif(!($row = mysqli_fetch_array($result))) {
